...
exports.default = {
  ...
  render: function render(h) {
    ...
    var submenuTitleIcon = rootMenu.mode === 'horizontal' && isFirstLevel || rootMenu.mode === 'vertical' && !rootMenu.collapse ? 'el-icon-arrow-down' : 'icon-xiangyou';
    ...
    return h(
      ...
      [h(
        ...
        [$slots.title, h(
          'i',
          { 'class': ['iconfont el-submenu__icon-arrow', submenuTitleIcon] },
          []
        )]
